...
export const WorkstationTable: React.FC<Props> = ({workstation, status, employeeData}) => {
  ...
  const Verhistorico = (employee: Employee) =>{
    navigate('/history', {state: {employeeData}})
  }
  ...
  return (
      ...
      <div className='employee-container'>
        ...
        <p >{role} {registration}</p>
          ...
          <button onClick={() => Verhistorico(employeeData)}>Ver Histórico</button>
